...
var options_get_brands = {
 ...
 async function get_brands(options) {
    ...
    var allBrands = [];
    const b = await axios(options) .then(response => {console.log(response)});
    console.log("Brands " + JSON.stringify(b));
         ...
         // console.log(total_profiles);
          ...
          //  console.log(brand.profile_type);
            //console.log(brand_name + " " + brand.profile_type);
             ...
             const money =  get_fans_engagement(brand_id, brand.profile_type, 1608209422374, 1639745412436);
             console.log("Money " + money);

            //  await get_fans_engagement(brand_id, brand.profile_type, 1608209422374, 1639745412436) 
                // function(fans, engagement){
                  //console.log(fans);
...
const response = await axios(options_get_profile_data)
